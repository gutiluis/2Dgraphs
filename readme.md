...
2D Grapher in Matplotlib

Graph functions, and ranges in python
...
```python
git clone https://github.com/gutiluis/2Dgraphs.git
cd 2Dgraphs
python -m venv venv
...
* **GitHub Discussions:** [Open a discussion](https://github.com/gutiluis/2Dgraphs/discussions)
